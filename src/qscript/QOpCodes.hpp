...
OP(LOAD_FIELD, 1, sizeof(uint_field_index_t), sizeof(uint_field_index_t)),
OP(LOAD_STATIC_FIELD, 1, sizeof(uint_field_index_t), sizeof(uint_field_index_t)),
...
OP(STORE_FIELD, 0, sizeof(uint_field_index_t), sizeof(uint_field_index_t)),
OP(STORE_STATIC_FIELD, 0, sizeof(uint_field_index_t), sizeof(uint_field_index_t)),
...
OP(CALL_METHOD, 255, sizeof(uint8_t) + sizeof(uint_method_symbol_t), sizeof(uint8_t) | (sizeof(uint_method_symbol_t)<<4)),
OP(CALL_SUPER, 255, sizeof(uint8_t) + sizeof(uint_method_symbol_t), sizeof(uint8_t) | (sizeof(uint_method_symbol_t)<<4)),
