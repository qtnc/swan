...
listClass
->copyParentMethods()
->bind("[]", listSubscript, "L%0")
->bind("[]=", listSubscriptSetter, "L%0%0")
->bind("iterator", listIterator, "LCI1%0")
->bind("length", listLength, "LN")
->bind("toString", listToString, "LS")
->bind("clear", listClear, "LU")
->bind("add", listPush, "L%0+B")
->bind("append", listPush, "L%0+B")
->bind("remove", listRemove, "L%0%0")
->bind("removeIf", listRemoveIf, "LCF2%0B@0")
->bind("push", listPush, "L%0+B")
->bind("pop", listPop, "L%0")
->bind("insert", listInsert, "LN%0+@0")
->bind("removeAt", listRemoveAt, "LO+@0")
->bind("indexOf", listIndexOf, "L%0N?N")
->bind("lastIndexOf", listLastIndexOf, "L%0N?N")
->bind("sort", listSort)
->bind("fill", listFill)
->bind("reverse", listReverse, "L@0")
->bind("rotate", listRotate, "LN@0")
->bind("lower", listLowerBound, "L%0N")
->bind("upper", listUpperBound, "L%0N")
->bind("resize", listResize, "LN@0")
->bind("reserve", listReserve, "LN@0")
->bind("==", listEquals, "LOB")
->bind("*", listTimes, "LN@0")
->assoc<QList>();
...
listIteratorClass
->copyParentMethods()
->bind("next", listIteratorNext, "O%0")
->bind("previous", listIteratorPrevious, "O%0")
->bind("remove", listIteratorRemove, "O%0")
->bind("add", listIteratorInsert, "O%0@0")
->bind("insert", listIteratorInsert, "O%0@0")
->bind("set", listIteratorSet, "O%0%0")
->bind("-", listIteratorMinus, "O@0N")
->bind("unp", listIteratorIndex, "ON")
->assoc<QListIterator>();
