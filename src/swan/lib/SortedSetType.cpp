...
sortedSetClass
->copyParentMethods()
->bind("&", setIntersection, "OCQSortedSet;1%0CQSortedSet;1%0")
->bind("|", setUnion, "OCQSortedSet;1%0CQSortedSet;1%0")
->bind("-", setDifference, "OCQSortedSet;1%0CQSortedSet;1%0")
->bind("^", setSymetricDifference, "OCQSortedSet;1%0CQSortedSet;1%0")
->bind("iterator", setIterator, "OCI1%0")
->bind("toString", setToString, "OS")
->bind("length", setLength, "ON")
->bind("clear", setClear, "OU")
->bind("add", setAdd, "O%0+B")
->bind("remove", setRemove, "O%0%0")
->bind("lower", setLowerBound, "O%0%0")
->bind("upper", setUpperBound, "O%0%0")
->bind("pop", setPop, "O%0")
->bind("shift", setShift, "O%0")
->bind("first", setFirst, "O%0")
->bind("last", setLast, "O%0")
->bind("in", setIn, "O%0B")
->bind("==", setEquals, "OOB")
->assoc<QSortedSet>();
...
->bind("previous", setIteratorPrevious, "O%0")
->bind("remove", setIteratorRemove, "O%0")
