...
QFiber (QVM& vm);
QFiber (QVM& vm0, QClosure& closure): QFiber(vm0) { callFrames.push_back({ &closure,  closure.func.bytecode, 0 }); }
void adjustArguments (int nArgs, int nClosureArgs, bitmask<FunctionFlag> flags);
