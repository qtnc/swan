...
// Modified by QuentinC
// Added bitmask<E> empty constructor
// ADded bitmask<E> explicit operations (set, clear, flip)
// Added even more simplification macro
...
bitmask& clear (T x) { *this &=~x; return *this; }
bitmask& set (T x) { *this |= x; return *this; }
